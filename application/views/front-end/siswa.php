          ...
          <ul class="nav navbar-nav">
            <?php if ($this->session->userdata('login') == true) {?>
              <li id="user">
                ...
                <p style="text-transform: uppercase;"><?= ($users['jns_kelamin']=='L')?'Laki-laki':'Perempuan'; ?></p>
              </li>
            <?php } ?>
          </ul>
        </div>
...
<div class="row">
  ...
  <div class="col-sm-6 col-md-6">
    <div class="row left">
      <div class="col-md-6">
        <img src="<?= base_url() ?>assets/img/KPU.png" alt="" class="img-responsive">
      </div><br>
      <div class="col-md-6">
        <p>
          <b>Cara Memilih:</b><br>
          <p>
            Login dengan memasukkan Username dan Password yang sudah ditentukan untuk melakukan pemilihan Ketua OSIS. Pilih dengan cara mengklik tombol pilih
          </p>
        </p>
      </div>
    </div><hr>
...
?>    
    ...
    <footer class="footer">
      <div class="container">
        ...
        <span class="pull-right"><span class="text-danger">Made with love ❤</span> MAN IC PASURUAN </span>
      </div>
    </footer>
